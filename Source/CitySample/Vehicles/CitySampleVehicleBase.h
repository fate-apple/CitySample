...
private:
	...
	void HandbrakeActionPressedBinding(const struct FInputActionValue& ActionValue);
	void HandbrakeActionReleasedBinding(const struct FInputActionValue& ActionValue);
