...
public:
	...
	bool ShouldRestartPieEachIteration() const { return bRestartPieEachIteration; }
	double GetSecondsBetweenIterationsPIE() const { return bSecondsBetweenIterationsPIE; }
...
private:
	...
	bool bRestartPieEachIteration = false;

	double bSecondsBetweenIterationsPIE = 5.;
